    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        atendance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(StudentDash.this, Attendance.class);
        ...
        planner.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(StudentDash.this, Planner.class);
                startActivity(intent);
        ...
        teacher.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(StudentDash.this, Teacher.class);
                startActivity(intent);
        ...
        library.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(StudentDash.this, Librar.class);
                startActivity(intent);
        ...
        users.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(StudentDash.this, Users.class);
                startActivity(intent);
        ...
        courses.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(StudentDash.this, Courses.class);
                startActivity(intent);
        ...
        survey.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(StudentDash.this, Survey.class);
                startActivity(intent);
        ...
        transport.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(StudentDash.this, Transport.class);
                startActivity(intent);
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                e.clear();
                e.commit();
                Intent intent = new Intent(StudentDash.this, MainActivity.class);
                startActivity(intent);
                finish();
