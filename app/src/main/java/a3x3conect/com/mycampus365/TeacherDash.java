...
public class TeacherDash extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.teacher_dash);
        ...
        atendance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(TeacherDash.this, Attendance.class);
        ...
        planner.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(TeacherDash.this, Planner.class);
                startActivity(intent);
        ...
        teacher.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(TeacherDash.this, Teacher.class);
                startActivity(intent);
        ...
        library.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(TeacherDash.this, Librar.class);
                startActivity(intent);
        ...
        users.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(TeacherDash.this, Users.class);
                startActivity(intent);
        ...
        courses.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(TeacherDash.this, Courses.class);
                startActivity(intent);
        ...
        survey.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(TeacherDash.this, Survey.class);
                startActivity(intent);
        ...
        transport.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(TeacherDash.this, Transport.class);
                startActivity(intent);
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                e.clear();
                e.commit();
                Intent intent = new Intent(TeacherDash.this, MainActivity.class);
                startActivity(intent);
                finish();
